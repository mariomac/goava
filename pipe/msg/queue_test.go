...
func TestNoSubscribers_NotBlocking(t *testing.T) {
	...
	test.ReadChannel(t, sent, timeout)
	test.ChannelEmpty(t, sent, 5*time.Millisecond)
}
...
func TestMultipleSubscribers(t *testing.T) {
	...
	assert.Equal(t, 123, test.ReadChannel(t, ch1, timeout))
	assert.Equal(t, 123, test.ReadChannel(t, ch2, timeout))
	test.ChannelEmpty(t, ch1, 5*time.Millisecond)
	test.ChannelEmpty(t, ch2, 5*time.Millisecond)
}
...
func TestClose(t *testing.T) {
	...
	assert.Equal(t, 123, test.ReadChannel(t, ch1, timeout))
	assert.Equal(t, 123, test.ReadChannel(t, ch2, timeout))
	assert.Equal(t, 456, test.ReadChannel(t, ch1, timeout))
	assert.Equal(t, 456, test.ReadChannel(t, ch2, timeout))

	test.ChannelEmpty(t, ch1, time.Second)
	test.ChannelEmpty(t, ch1, time.Second)
}
